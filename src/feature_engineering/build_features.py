...
"""
    ...
    assumptions = """# Unit Economics Assumptions
...
"""
    ...
    (REPORTS_DIR / "feature_dictionary.md").write_text(feature_dictionary, encoding="utf-8")
    (REPORTS_DIR / "unit_economics_assumptions.md").write_text(assumptions, encoding="utf-8")
